...
async function heraldHud_renderHtml() {
  try {
    const response = await fetch(
      "/modules/herald-hud/templates/heraldHud-container.html"
    );
...
async function heraldHud_renderOverlayHudbarFrame() {
  ...
  if (overlayDiv) {
    ...
    let urlImg = heraldHud_speedHudbarOff
      ? "/modules/herald-hud/assets/hudbar-frame/1-line/"
      : "/modules/herald-hud/assets/hudbar-frame/2-line/";
...
async function heraldHud_renderBgBehindDialog() {
  ...
  if (dialog) {
    if (!imageName || imageName === "none") {
      ...
      dialog.style.backgroundImage = `
      url("/modules/herald-hud/assets/hudbg-dialog/opacity-50/${imageName}_50bg.png"),
      url("/modules/herald-hud/assets/hudbg-dialog/opacity-50/splash_bottom_bg.png")`;
  ...
  if (preparedSpellsActionContainerDiv && spellsData.length > 0) {
    ...
    <div id="heraldHud-preparedSpellsContainer" class="heraldHud-preparedSpellsContainer">
      <div id="heraldHud-preparedSpellsWrapper" class="heraldHud-preparedSpellsWrapper">
        ...
        <img
          src="/modules/herald-hud/assets/spellsprep_img.webp"
          alt=""
  ...
  if (journalingContainerDiv) {
    ...
    <div id="heraldHud-journalingDivContainer" class="heraldHud-journalingDivContainer">
      ...
      <div id="heraldHud-journalingButton" class="heraldHud-journalingButton"></div>
       <img
          src="/modules/herald-hud/assets/menudetail_icon.webp"
          alt=""
  ...
  if (showWeaponMaster) {
    ...
    <div id="heraldHud-weaponMasteryDiv" class="heraldHud-weaponMasteryDiv">
      ...
      <div id="heraldHud-weaponMasteryButton" class="heraldHud-weaponMasteryButton"></div>
       <img
          src="/modules/herald-hud/assets/weaponmastery_img.webp"
          alt=""
...
async function heraldHud_updateShorcutButton() {
  ...
  let buttonHtml = `
    <div id="heraldHud-shortcutButtonView" class="heraldHud-shortcutButtonView" >
      ...
      <img src="/modules/herald-hud/assets/d20_icon.png" alt="Shortcut Icon" class="heraldHud-shortcutButtonImg"/>
...
async function heraldHud_updateDataActor() {
  ...
  if (hpBarDiv) {
    if (hp > 0) {
      ...
      if (overlayThorn) {
        overlayThorn.innerHTML = `
        <img src="/modules/herald-hud/assets/thorn_0hp.png" class="heraldHud-overlayThorn0hpImg"/>`;
      }

      if (thornButton) {
        thornButton.innerHTML = `
        <img src="/modules/herald-hud/assets/thorn_crystalButton.png" id="heraldHud-deathSaveTrigger" class="heraldHud-deathSaveTrigger"/>`;
  ...
  if (tempHp > 0 || tempHp != "") {
    ...
    if (tempShieldContainerDiv) {
      tempShieldContainerDiv.innerHTML = `<img src="/modules/herald-hud/assets/tempshield_icon.png" alt="shield" class="heraldHud-tempShieldImage" />`;
    }
...
async function heraldHud_renderHtmlDialog() {
  try {
    const response = await fetch(
      "/modules/herald-hud/templates/heraldHud-dialog.html"
    );
    const html = await response.text();
  ...
  let hudFrameOptions = heraldHud_listOverlayHudbarFrame
    .map((frame) => {
      let label = frame
        ...
        .join(" ");
      return `<option value="${frame}" style="background-color: #121212; color: white;" ${
  ...
  let dialogContent = `
    <div style="display: flex; flex-direction: column; gap: 10px; padding-top:10px;padding-bottom:5px;">
      <div id="heraldHud-settingKofiSupportContainer" class="heraldHud-settingKofiSupportContainer" style="cursor:pointer;">
        <img src="/modules/herald-hud/assets/kofi_image.png" alt="Ko-fi" style="border:none;height:30px;"/>
      ...
      save: {
        ...
        callback: async (html) => {
          ...
          if (
            ...
            selectedPlayerColor !== user.color
          ) {
            await heraldHud_changeUserConfiguration(
              ...
              <div id="heraldHud-npcActionContainer-${id.tokenId}" class="heraldHud-npcActionContainer">
                <div class="heraldHud-npcActionButtonContainer">
                  ...
                  <div id="heraldHud-npcActionButton" class="heraldHud-npcActionButton" data-id="${id.tokenId}" data-type="initiative" >
                    <img src="/modules/herald-hud/assets/blued20_icon.png" alt="Initiative" style="width:20px;height:20px; border:none"/>
                  ...
                  <div id="heraldHud-npcActionButton" class="heraldHud-npcActionButton" data-id="${id.tokenId}" data-type="endturn">
                    <img src="/modules/herald-hud/assets/blued20_icon.png" alt="End Turn" style="width:20px;height:20px; border:none"/>
              ...
              <div id="heraldHud-npcMidContainerMiddle" class="heraldHud-npcMidContainerMiddle">
                ...
                <div id="heraldHud-npcAcContainer" class="heraldHud-npcAcContainer">
                  <div class="heraldHud-npcAcIconWrapper">
                      <img
                        src="/modules/herald-hud/assets/ac_icon.webp"
                        alt="Armor Class"
...
async function heraldHud_getDataListNpc() {
  ...
  for (let id of heraldHud_npcPlayerSelected) {
    ...
    if (tempHp > 0 || tempHp != "") {
      ...
      if (tempShieldDiv) {
        tempShieldDiv.innerHTML = `<img src="/modules/herald-hud/assets/tempshield_icon.png" alt="shield" class="heraldHud-npcTempShield" />`;
      }
...
async function heraldHud_renderHtmlNpcDialog() {
  try {
    const response = await fetch(
      "/modules/herald-hud/templates/heraldHud-npcDialog.html"
    );
    const html = await response.text();
...
async function heraldHud_addInspirationView() {
  ...
  const inspirationIcon = hasInspiration
    ? "/modules/herald-hud/assets/inspiration_on.webp"
    : "/modules/herald-hud/assets/inspiration_off.webp";
    ...
    inspirationContainer.innerHTML = `
      <div class="heraldHud-inspirationLevelWrapper">
        ...
        <div class="heraldHud-levelActorContainer">
          <img
            src="/modules/herald-hud/assets/level_icon.webp"
            alt="Level Icon"
